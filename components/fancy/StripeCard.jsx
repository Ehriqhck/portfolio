    ...
    <>
      <div className='w-[90%] h-[480px] group mx-auto dark:bg-[#252525] p-2 bg-white dark:border-0 border overflow-hidden rounded-md dark:text-white text-black '>
        ...
        <article className='  p-4 space-y-2'>
          ...
          <a
            href='#'
            className=' text-light dark:text-white text-blue-600 font-normal  group-hover:opacity-100 opacity-0 translate-y-2 group-hover:translate-y-0 pt-2 flex gap-1  transition-all duration-300  '
          >
            Learn about Atlas
            <span>
            </span>
