            ...
            >
              ...
              <div className="w-full h-fit  mx-auto gap-10 flex flex-col">
                ...
                <FeatureCarousel
                  ...
                  title=<p className="text-CIAAN-light">CIAAN Security Corporation </p>
                  descriptionClassName="bg-animated-cards-description-scas backdrop-blur-[10px]"
                  description=<p className="text-CIAAN-light">Cybersecurity Assessment & Engagement Automation</p>
                  overview=<p>SCAS (Security Controls & Automation System) is a platform of cybersecurity tools initially tailored for T-Mobile Security Staff.<br></br>  Here, I designed SCAS's workflow for automating assessment & engagement creation & management.</p>
                ...
                <FeatureCarousel
                  ...
                  title=<p className="text-gradient-display "> Trichord Digital LLC.</p>
                  descriptionClassName="panel-white bg-panel-white backdrop-blur-[5px] flex flex-col  "
                  description=<p className="text-gradient-display ">Flightsim Keybind Mapping Automation</p>
                  overview=<p className="text-tri-light">SCAS (Security Controls & Automation System) is a platform of cybersecurity tools initially tailored for T-Mobile Security Staff.<br></br>  Here, I designed SCAS's workflow for automating assessment & engagement creation & management.</p>
